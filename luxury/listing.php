...
<section class="breadcrumb-wrap list-wrap">
    ...
    <div class="list products">
        <div class="container">
            <div class="list-wrapp owl-carousel">
                <div class="list-block">
                    <a href="listing.php">
                        <img src="img/product/bear.png" alt="">
                        <h5>Toys and Accesories</h5>
                    </a>
                </div>
                <div class="list-block">
                    <a href="listing.php">
                        <img src="img/product/mobile.png" alt="">
                        <h5>Mobile and Tablets</h5>
                    </a>
                </div>
                <div class="list-block">
                    <a href="listing.php">
                        <img src="img/product/mouse.png" alt="">
                        <h5>Electronic Accesories</h5>
                    </a>
                </div>
                <div class="list-block">
                    <a href="listing.php">
                        <img src="img/product/laptop.png" alt="">
